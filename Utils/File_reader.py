...
class ExcelReader:
    ...
    def data(self):
        if not self._data:
            ...
            #先遍历行，将行值放置成一个数组，之后遍历这个数组中的所有列值
            if self.title_line:
...
if __name__ == '__main__':
    y = '/Users/duxiaodi/PycharmProjects/SidenyUITest/ConfigMethod/configdr.yml'
    reader = YamlReader(y)
    print(reader.data)


    e = '/Users/duxiaodi/PycharmProjects/SidenyUITest/Data/dxd.xlsx'
